...
This post is a code-first implementation of the Feature-Based Expected Goals (xG) Model from Jonathan Arsenault's PhD thesis. The model is described in Section 2.4 of his thesis. The model uses tracking data in the development of an xG model that incorporates features such as shooter motion, pressure from defenders, pre-shot puck movement, and goaltender positioning. 

We will be using data from the [Big Data Cup 2026](https://github.com/bigdatacup/Big-Data-Cup-2026), which contains Stathletes-tracked event data as well as player tracking data generated from broadcast video. All code is written using Claude Opus 4.8 and verified by the author.
