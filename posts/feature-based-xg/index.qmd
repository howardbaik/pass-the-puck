...
With feature engineering complete, we can now train an XGBoost model to predict each shot's probability of becoming a goal. First, we consolidate all the features above into a single dataset by joining them on `shot_id`.
