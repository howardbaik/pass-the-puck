...
A Jupyter notebook of the code is available [here](https://github.com/howardbaik/player-tracking-data/blob/main/feature-based-xg/feature-based-expected-goals.ipynb).